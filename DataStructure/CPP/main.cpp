...
namespace jj20
{
     ...
     void test_list_with_special_allocator()
     {
          ...
          list<string, std::allocator<string>> c1;              //3140
          ...
          vector<int> ins;
          ins.emplace_back(1234);
          ins.emplace_back(14242);
          cout << ins.size() << "\t" << ins.capacity() << endl;
          ins.pop_back();
          cout << ins.size() << "\t" << ins.capacity() << endl;
          ...
          cout << "allloc1=" << sizeof(alloc1) << "\t"
               << "alloc2 = " << sizeof(alloc2) << "\t"
               << " alloc3 = " << sizeof(alloc3) << "\t "
               << " alloc3 = " << sizeof(alloc4) << "\t "
               << " alloc3 = " << sizeof(alloc5) << "\t "
               << " alloc3 = " << sizeof(alloc6) << "\t ";
